...
//                if (a[middlePointer] < arv) {
//                    leftPointer = middlePointer + 1;
//                } else if (a[middlePointer] > arv) {
...
//                if (a[middlePointer] <= arv) middlePointer++;

//                System.arraycopy(a, middlePointer, a, middlePointer + 1, i - middlePointer);
//            }
...
//    }
    ...
    static void binaryInsertionSort(double[] a) {
        for (int i = 1; i < a.length; ++i) {
            double currentValue = a[i];
            int positionToInsert = binarySearch(a, currentValue, 0, i - 1);

            System.arraycopy(a, positionToInsert, a, positionToInsert + 1, i - positionToInsert);
            a[positionToInsert] = currentValue;
        }
    }
